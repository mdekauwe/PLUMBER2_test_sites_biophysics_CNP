...
class RunCable(object):
    ...
    def worker(self, met_files, url, rev, param_names, param_values,
        ...
        for fname in met_files:
            site = os.path.basename(fname).split(".")[0][0:6]
            print(site)
...
if __name__ == "__main__":
    ...
    #              'US-Ha1_1991-2012_FLUXNET2015_Met.nc']
    ...
    shutil.move(out_fname, os.path.join(output_dir, "%s_biophysics.nc" % (site)))
    """
    ...
    #"""
    met_subset = ['US-Ha1_1991-2012_FLUXNET2015_Met.nc']
    site = met_subset[0].split(".")[0][0:6]
