...
def plot_carbon_fluxes(cycle, ds, ds_cable):
    ...
    plot_fname = "%s_historical_carbon_fluxes_and_pools.png" % (cycle)
    plot_dir = "plots"
...
def plot_nitrogen_fluxes(cycle, ds):
    ...
    plot_fname = "%s_historical_nitrogen_fluxes.png" % (cycle)
    plot_dir = "plots"
    if not os.path.exists(plot_dir):
        os.makedirs(plot_dir)
...
def plot_phosphorus_fluxes(cycle, ds):
    ...
    plot_fname = "%s_historical_phosphorus_fluxes.png" % (cycle)
    plot_dir = "plots"
    if not os.path.exists(plot_dir):
        os.makedirs(plot_dir)
...
def plot_cnp_states(cycle, ds):
    ...
    plot_fname = "%s_historical_state.png" % (cycle)
    plot_dir = "plots"
    if not os.path.exists(plot_dir):
        os.makedirs(plot_dir)
