...
def plot_spinup_state(ds, cycle):
    ...
    fig.tight_layout()
    plot_fname = "spinup_carbon_pools_single_file_%d.pdf" % (cycle)
...
if __name__ == "__main__":
    ...
    fname = os.path.join(fdir, "AU-Tum_C_out_casa_spin_%d.nc" % (cycle))
    ds = xr.open_dataset(fname, decode_times=False)
    plot_spinup_state(ds, cycle)
